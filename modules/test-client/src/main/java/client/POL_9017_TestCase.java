 ...
 * A testcase to verify that a reference with propagatesTransaction on a local tran component,
 *  results in an error from the runtime.
 * 
 * This testcase is expected to fail.
 */
public class POL_9017_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_9017" , "Policy_General" , "General_Java" };
