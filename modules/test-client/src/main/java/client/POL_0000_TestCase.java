...
/**
 * Client for POL_0000_TestCase
 * Tests that the testing harness is working properly with a very basic SCA testcase
 * 
 * This testcase is expected to succeed
 */
public class POL_0000_TestCase extends BaseJAXWSTestRunner {

    protected TestConfiguration getTestConfiguration() {
    	TestConfiguration config = new TestConfiguration();
    	config.testName 		 = this.getClass().getSimpleName().substring(0, 8);
    	config.input 		 	 = "request";
    	config.output[0] 		 = "POL_0000 request service1 operation1 invoked";
