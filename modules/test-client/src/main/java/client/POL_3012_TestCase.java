 ...
 */
public class POL_3012_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_3012" , "Policy_General" , "General_Java" };
