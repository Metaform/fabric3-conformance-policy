 ...
 */
public class POL_9023_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_9023" , "Policy_General" , "General_Java" };
