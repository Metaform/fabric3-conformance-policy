...
/**
 * Client for POL_4001_TestCase
 * Tests that directly attached policy sets are overridden by externally attached policySets.
 * 
 * This testcase is expected to fail.
 */
public class POL_4001_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_4001" , "Policy_General" , "General_Java" };
