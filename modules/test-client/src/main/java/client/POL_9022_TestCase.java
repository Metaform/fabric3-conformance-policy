...
/**
 * Client for POL_9022_TestCase
 * Tests that where a <component/> <reference/> is marked with the asyncInvocation intent 
 * it is not also marked with the propagatesTransaction intent
 * 
 * This testcase is expected to fail.
 */
public class POL_9022_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_9022" , "Policy_General" , "General_Java" };
