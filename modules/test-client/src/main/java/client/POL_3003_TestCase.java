 ...
 */
public class POL_3003_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_3003" , "Policy_General" , "General_Java" };
