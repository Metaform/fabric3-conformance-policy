 ...
 */
public class POL_4010_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_4010" , "Policy_General" , "General_Java" };
