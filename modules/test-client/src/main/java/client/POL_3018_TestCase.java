...
public class POL_3018_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_3018" , "Policy_General" , "General_Java" };
