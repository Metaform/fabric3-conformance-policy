...
/**
 * Client for POL_4005_TestCase
 * Tests that qualified intents override qualifiable intents on component/component services.
 * 
 * This testcase is expected to fail.
 */
public class POL_4005_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_4005" , "Policy_General" , "General_Java" };
