 ...
 */
public class POL_11001_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_11001" , "Policy_General" , "General_Java" };
