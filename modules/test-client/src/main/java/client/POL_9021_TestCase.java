 ...
 */
public class POL_9021_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_9021" , "Policy_General" , "General_Java" , "Policy_General_Java" };
