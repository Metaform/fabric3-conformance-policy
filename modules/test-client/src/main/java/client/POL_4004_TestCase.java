...
/**
 * Client for POL_4004_TestCase
 * Tests that qualified intents override qualifiable intents on implementations.
 * 
 * This testcase is expected to fail.
 */
public class POL_4004_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_4004" , "Policy_General" , "General_Java" };
