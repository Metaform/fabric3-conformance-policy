...
/**
 * Client for POL_9006_TestCase
 * A testcase to verify that a reference with transactedOneWay on a non-global tran component,
 * results in an error from the runtime.
 * 
 * This testcase is expected to fail.
 */
public class POL_9006_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_9006" , "Policy_General" , "General_Java" , "Policy_General_Java" };
