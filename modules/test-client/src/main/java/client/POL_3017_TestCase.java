...
public class POL_3017_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_3017" , "Policy_General" , "General_Java" };
