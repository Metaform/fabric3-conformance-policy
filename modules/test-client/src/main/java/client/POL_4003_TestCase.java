...
/**
 * Client for POL_4003_TestCase
 * Tests that that externally attached policy sets are supported.
 * 
 * This testcase is expected to succeed.
 */
public class POL_4003_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_4003" , "Policy_General" , "General_Java" };
