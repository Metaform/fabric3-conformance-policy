...
/**
 * Client for POL_4027_TestCase
 * A testcase to verify that the runtime can detect duplicate bindingType definitions.
 * 
 * This testcase is expected to fail.
 */
public class POL_4027_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_4027" , "Policy_General" , "General_Java" };
