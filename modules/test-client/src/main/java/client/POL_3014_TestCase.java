...
public class POL_3014_TestCase extends BaseJAXWSTestRunner {
    ...
    protected TestConfiguration getTestConfiguration() {
    	...
    	config.contributionNames = new String[] { "POL_3014" , "Policy_General" , "General_Java" };
